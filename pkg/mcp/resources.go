...
**Options:** ` + "`" + `files` + "`" + ` (required) plus ` + "`" + `skipAnchors` + "`" + `, ` + "`" + `skipEmbeds` + "`" + `, ` + "`" + `includeFrontmatter` + "`" + `, ` + "`" + `includeBacklinks` + "`" + ` (default true), ` + "`" + `includeNeighbors` + "`" + `, ` + "`" + `includeTags` + "`" + `, ` + "`" + `neighborLimit` + "`" + ` (default 50), ` + "`" + `backlinksLimit` + "`" + ` (default 50), ` + "`" + `exclude` + "`" + `, ` + "`" + `include` + "`" + `, ` + "`" + `minDegree` + "`" + `, ` + "`" + `mutualOnly` + "`" + `. ` + "`" + `minDegree` + "`" + ` prunes nodes/edges before all stats, orphans, and communities are computed.
