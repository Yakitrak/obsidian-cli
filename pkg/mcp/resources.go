...
**Options:** same filters as ` + "`" + `graph_stats` + "`" + `: ` + "`" + `skipAnchors` + "`" + `, ` + "`" + `skipEmbeds` + "`" + `, ` + "`" + `includeTags` + "`" + `, ` + "`" + `exclude` + "`" + `, ` + "`" + `include` + "`" + `, ` + "`" + `minDegree` + "`" + `, ` + "`" + `mutualOnly` + "`" + `, ` + "`" + `recencyCascade` + "`" + ` (cascade inferred recency beyond 1 hop; default true), plus ` + "`" + `maxCommunities` + "`" + `, ` + "`" + `maxTopNotes` + "`" + `.
...
**Options:** provide one of ` + "`" + `id` + "`" + ` or ` + "`" + `file` + "`" + ` plus: ` + "`" + `skipAnchors` + "`" + `, ` + "`" + `skipEmbeds` + "`" + `, ` + "`" + `includeTags` + "`" + `, ` + "`" + `includeNeighbors` + "`" + `, ` + "`" + `exclude` + "`" + `, ` + "`" + `include` + "`" + `, ` + "`" + `minDegree` + "`" + `, ` + "`" + `mutualOnly` + "`" + `, ` + "`" + `recencyCascade` + "`" + ` (default true), ` + "`" + `limit` + "`" + `.
...
**Options:** ` + "`" + `files` + "`" + ` (required) plus ` + "`" + `skipAnchors` + "`" + `, ` + "`" + `skipEmbeds` + "`" + `, ` + "`" + `includeFrontmatter` + "`" + `, ` + "`" + `includeBacklinks` + "`" + ` (default true), ` + "`" + `includeNeighbors` + "`" + `, ` + "`" + `includeTags` + "`" + `, ` + "`" + `neighborLimit` + "`" + ` (default 50), ` + "`" + `backlinksLimit` + "`" + ` (default 50), ` + "`" + `exclude` + "`" + `, ` + "`" + `include` + "`" + `, ` + "`" + `recencyCascade` + "`" + ` (default true), ` + "`" + `minDegree` + "`" + `, ` + "`" + `mutualOnly` + "`" + `. ` + "`" + `minDegree` + "`" + ` prunes nodes/edges before all stats, orphans, and communities are computed.
...
**Options:** ` + "`" + `skipAnchors` + "`" + `, ` + "`" + `skipEmbeds` + "`" + `, ` + "`" + `includeTags` + "`" + `, ` + "`" + `exclude` + "`" + `, ` + "`" + `include` + "`" + `, ` + "`" + `recencyCascade` + "`" + ` (default true), ` + "`" + `minDegree` + "`" + `, ` + "`" + `mutualOnly` + "`" + `, ` + "`" + `maxCommunities` + "`" + `, ` + "`" + `communityTopNotes` + "`" + `, ` + "`" + `communityTopTags` + "`" + `, ` + "`" + `bridgeLimit` + "`" + `, ` + "`" + `topOrphans` + "`" + `, ` + "`" + `topComponents` + "`" + `, ` + "`" + `topNotes` + "`" + `, ` + "`" + `keyPatterns` + "`" + ` (defaults to vault config keyNotePatterns), ` + "`" + `contextFiles` + "`" + `, contextIncludeBacklinks/frontmatter/neighbors/tags, ` + "`" + `contextNeighborLimit` + "`" + `, ` + "`" + `contextBacklinksLimit` + "`" + `. ` + "`" + `minDegree` + "`" + ` prunes nodes/edges before stats, orphans, communities, and key notes are calculated.
